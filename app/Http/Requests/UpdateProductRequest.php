...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image_1' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:30720',
            'image_2' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:30720',
            'image_3' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:30720',
            'image_4' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:30720',
            'pdf_file' => 'nullable|file|mimes:pdf|max:51200',
            'audio_file' => 'nullable|file|mimes:mp3,mpga,mpeg,m4a,ogg,wav|max:102400',
            'online_lezen_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:5120',
    ...
    public function messages(): array
    {
        return [
            ...
            'parent_id.exists' => 'Ongeldig parent product.',
            ...
            'audio_file.file' => 'Audio bestand moet een bestand zijn.',
            'audio_file.mimes' => 'Audio bestand moet MP3, M4A, OGG of WAV zijn.',
            'audio_file.max' => 'Audio bestand mag maximaal 100MB zijn.',
            'online_lezen_image.image' => 'Online Lezen afbeelding moet een afbeelding zijn.',
            'online_lezen_image.mimes' => 'Online Lezen afbeelding moet jpeg, png, jpg, gif, svg of webp zijn.',
            'online_lezen_image.max' => 'Online Lezen afbeelding mag maximaal 5MB zijn.',
