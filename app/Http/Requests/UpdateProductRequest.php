...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image_1' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:30720',
            'image_2' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:30720',
            'image_3' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:30720',
            'image_4' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:30720',
            'pdf_file' => 'nullable|file|mimes:pdf|max:51200',
            'audio_file' => 'nullable|file|mimes:mp3,mpga,mpeg,m4a,ogg,wav|max:102400',
            'online_lezen_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:5120',
    ...
    public function messages(): array
    {
        return [
            ...
            'pages.min' => 'Aantal pagina\'s moet minimaal 0 zijn.',
            ...
            'online_lezen_image.mimes' => 'Online Lezen afbeelding moet jpeg, png, jpg, gif, webp zijn.',
