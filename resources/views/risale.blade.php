<x-layout :seo-data="$SEOData">
    ...
    <main class="container page risale">
        <div class="risale-hero">
            <div class="container">
            <x-breadcrumbs :items="[
                ['label' => 'Home', 'url' => route('home')],
                ['label' => 'Wat is de Risale-i Nur?', 'url' => route('risale')],
            ]" />
            </div>
        </div>
        ...
        <div class="text-box-background">
            <div class="risale-i-nur-page__text-box">
                ...
                <img class="stapel-one" src="{{ asset('images/risale-i-nur-quran-tafsir-boeken.webp') }}" alt="Wat is de Risale-i Nur — spirituele Qur'an tafsir boeken van Said Nursi" title="Wat is de Risale-i Nur? Spirituele Qur'an Tafsir van Bediüzzaman Said Nursi" loading="lazy" decoding="async">

                <h2 class="sr-only">Wat is de Risale-i Nur? Geloofswaarheden met rationele bewijzen</h2>
                    <p>
                    <strong>In de Risale-i Nur daarentegen</strong> wordt deze tweede benadering niet ter aanvulling, maar direct als grondslag gehanteerd. De verankering van fundamentele geloofswaarheden is het primaire doel van deze spirituele Tafsir. Immers, tegenover de hedendaagse spirituele ziektes en antireligieuze indoctrinaties kan een geloofsovertuiging die op navolging berust moeilijk standhouden.
                        ...
                        <img class="stapel-two" src="{{ asset('images/risale-i-nur-quran-tafsir-boeken.webp') }}" alt="Wat is de Risale-i Nur — geloofswaarheden met rationele bewijzen" title="Wat is de Risale-i Nur? Rationele en diepgaande geloofswaarheden" loading="lazy" decoding="async">
