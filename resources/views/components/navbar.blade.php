<ul>
    ...
    <li class="nav-item">
        <a class="{{ request()->routeIs('risale') ? 'active' : '' }}" href="{{ route('risale') }}"><span
                class="first-letter">R</span>İSALE-İ NUR</a>
    </li>
    <li class="nav-item">
    ...
    @guest
        <li class="nav-item">
            <a class="{{ request()->routeIs('login') ? 'active' : '' }}" href="{{ route('login') }}"><i
