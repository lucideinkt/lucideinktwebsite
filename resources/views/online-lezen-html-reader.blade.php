        ...
        (function () {
            ...
            document.querySelectorAll('.reader-sheet-theme-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    saveTheme(mode);
                    // Update button active-states immediately so the tap feels instant,
                    // then defer the expensive full-document style recalculation to the
                    // next animation frame so the UI stays responsive.
                    document.querySelectorAll('.reader-sheet-theme-btn').forEach(b => {
