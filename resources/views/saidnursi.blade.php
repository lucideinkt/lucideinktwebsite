<x-layout :seo-data="$SEOData">
    ...
    <main class="container page said-nursi">
        ...
        <div class="text-box-background">
            ...
            <p>Op een dag had hij de profeet Mohammed <strong class="saw-honorific">ﷺ</strong> in zijn droom gezien en hem om kennis verzocht. Daarop gaf de profeet hem de tijding dat hem Qur’anische kennis geschonken zou worden, op voorwaarde dat hij geen vragen aan de oemma zou stellen. Deze tijding werd tijdens zijn leven verwezenlijkt. Op jeugdige leeftijd werd hij bekend als een uitblinkende geleerde van zijn tijdperk. Nooit stelde hij vragen aan anderen, terwijl hij altijd op alle vragen die hem gesteld werden heldere antwoorden gaf. Naarmate de tijd verstreek, bleek dat hij door de Goddelijke Beschikking was uitverkozen om een belangrijke taak te vervullen.</p>
            ...
            <p>Omdat de tijdgenoten van Said <span aria-label="Said Nursi">Nursî</span> zonneklare herkenningstekenen van een Mudjeddid bij hem zagen, noemden zij hem "<strong>de Mudjeddid van het einde der tijden</strong>". In de Risale-i Nur geeft Said <span aria-label="Said Nursi">Nursî</span> echter aan dat hem de titel "<strong>Mudjeddid</strong>" tijdelijk is toegekend om die uiteindelijk over te dragen aan de Risale-i Nur.</p>
