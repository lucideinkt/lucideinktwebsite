<x-layout>
    <main class="container page">
        <div class="said-nursi-page__text-box">
            ...
            <img src="{{ asset('images/said_nursi_standing.webp') }}" alt="">
            ...
            <p>Op een dag had hij de profeet Mohammed <strong>ﷺ</strong> in zijn droom gezien en hem om kennis verzocht. Daarop gaf de profeet hem de tijding dat hem Qur’anische kennis geschonken zou worden, op voorwaarde dat hij geen vragen aan de oemma zou stellen. Deze tijding werd tijdens zijn leven verwezenlijkt. Op jeugdige leeftijd werd hij bekend als een uitblinkende geleerde van zijn tijdperk. Nooit stelde hij vragen aan anderen, terwijl hij altijd op alle vragen die hem gesteld werden heldere antwoorden gaf. Naarmate de tijd verstreek, bleek dat hij door de Goddelijke Beschikking was uitverkozen om een belangrijke taak te vervullen.</p>

            <p>Zoals in een Hadith is overgeleverd, heeft de profeet Mohammed <strong>ﷺ</strong> het volgende verkondigd: “<em>Aan het begin van elke eeuw zal ALLAH een “<strong>Mudjeddid</strong></em>” (vernieuwer) zenden.” Deze “<em><strong>Mudjeddid</strong></em>” zal vertroebelde waarheden herstellen. Elke Mudjeddid is een uitverkoren geleerde die in zijn tijd de Qur’an en de Sunnah op de meest correcte wijze interpreteert en op de beste wijze verklaart. Zonder enige verandering in de Islamitische basisprincipes of kerngedachtes aan te brengen, hanteert een Mudjeddid nieuwe beschrijvingsmethodes en redeneringen om alle problemen en vraagstukken van de heersende tijdgeest te ontwarren en op te lossen.</p>
            ...
            <img src="{{ asset('images/said_nursi_wijzend.webp') }}" alt="">
            ...
            <img src="{{ asset('images/roses_new.webp') }}" alt="">
        </div>
    </main>
