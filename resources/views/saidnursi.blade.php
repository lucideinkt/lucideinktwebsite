<x-layout>
    <main class="container page">
        <div class="said-nursi-page__text-box">
            ...
            <img src="{{ asset('images/Rose_Said.webp') }}" alt="">
            <img src="{{ asset('images/young_said_nursi.webp') }}" alt="">
            ...
            <p>Zoals in een Hadith is overgeleverd, heeft de profeet Mohammed <strong>ﷺ</strong> het volgende verkondigd: "Aan het begin van elke eeuw zal ALLAH een "<strong>Mudjeddid</strong>" (vernieuwer) zenden." Deze "<strong>Mudjeddid</strong>" zal vertroebelde waarheden herstellen. Elke Mudjeddid is een uitverkoren geleerde die in zijn tijd de Qur'an en de Sunnah op de meest correcte wijze interpreteert en op de beste wijze verklaart. Zonder enige verandering in de Islamitische basisprincipes of kerngedachtes aan te brengen, hanteert een Mudjeddid nieuwe beschrijvingsmethodes en redeneringen om alle problemen en vraagstukken van de heersende tijdgeest te ontwarren en op te lossen.</p>
            ...
            <img src="{{ asset('images/rose_end.webp') }}" alt="">
        </div>
    </main>
