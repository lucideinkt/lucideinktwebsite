  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Nieuw exemplaar</span>
      </div>
    </li>
  </ol>
</nav>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
  <div class="lg:col-span-2">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      <div class="p-4 border-b border-gray-200 dark:border-gray-700">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Productexemplaar toevoegen</h2>
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Bijv. "Hardcover", "Paperback", "Luxe editie"</p>
      </div>
      <form id="copy-form" action="{{ route('productCopyStore') }}" method="POST" class="p-4 space-y-4">
        @csrf
  ...
  <div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
      ...
      <select name="is_published" form="copy-form"
        ...
        <option value="0" {{ old('is_published') == '0' ? 'selected' : '' }}>Concept</option>
